  ...
  function NavbarItem({ page, children, active = false, onPointerEnter }, ref) {
    ...
    return (
      <Link
        ...
        className={clsx(
          "flex gap-1 text-right transition-colors items-center w-full h-full justify-center px-3 focus-visible:text-zinc-100 relative focus-visible:outline-none focus-visible:bg-white/20",
