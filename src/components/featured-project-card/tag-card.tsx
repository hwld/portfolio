...
export const FeaturedProjectTagCard: React.FC<{
  ...
  return (
    <a
      className="px-2 pb-[2px] h-[24px] border border-border-strong rounded-sm flex gap-1 items-center transition-colors hover:bg-background-hover text-nowrap hover:text-foreground-strong group"
      target="_blank"
